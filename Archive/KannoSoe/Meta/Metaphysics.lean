/-
================================================================================
  KannoSoe.Meta.Metaphysics
  Śūnyatā on the re-emptying ladder — the Nishitani/Jizang layer as a
  consumer of the checked ladder in KannoSoe.Consequences.ContentRows
================================================================================
...
but it *imports* `KannoSoe.Consequences.ContentRows`, since every theorem here is a
...
appendix presupposes nothing of the grid and lives at `KannoSoe.Metaphysics`.
...
## API consumed (all from KannoSoe.Theory / KannoSoe.Theorems)
...
ladder-level relocation above. Placed at `KannoSoe.Metaphysics` rather than under
...
than mine. The ladder and consistency results show coherence, not that KannoSoe is
