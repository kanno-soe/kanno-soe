...
import KannoSoe.Consequences.Compounds
import KannoSoe.Consequences.ModelWitnesses
import KannoSoe.Doctrines
import KannoSoe.Identification
import KannoSoe.Meta.InvarianceNegative
import KannoSoe.Meta.Metaphysics
import KannoSoe.Meta.ReflexivityWitness
...
def glossary : List GlossaryEntry := [
  ...
  { term := "kannō-sōe"
    kind := .canonical
    gloss := "The term kannō-sōe means responsive resonance or mutual answering. In this system it is the second-row dependence face, where a call and a response are placed together."
  ...
  { term := "shushō-ittō"
    ...
    anchors := [``Grid.DirectedConvention.KsmdPoleDeed,
      ``Grid.DirectedConvention.KsmdEffectiveOccurrence,
      ``Grid.DirectedConvention.ksmdPoleDeed_of_produced_terminus]
    seeAlso := ["shō", "shu"] },
  { term := "shugenjō"
    kind := .coinage .theory
  ...
  { term := "reach-back"
    ...
    anchors := [``Grid.DirectedConvention.KsmdReachBackFull,
      ``Grid.DirectedConvention.deliveredTo_iff_ksmdReachBackFull]
  ...
  { term := "grade"
    ...
    anchors := [``Grid.grade, ``Grid.KsmdMismatchGrade, ``Grid.share_eq_grade_check]
    seeAlso := ["share", "weld"] },
  { term := "clench"
    kind := .coinage .theory
    ...
    anchors := [``Grid.HasSelfPoleIndex, ``Grid.KsmdAppropriates]
    seeAlso := ["share", "weld"] },
  { term := "arrogation"
    kind := .coinage .theory
  ...
  { term := "orthogonality rule"
    ...
    anchors := [``OrthogonalityNegative.ksmdEffectiveTerminus_stronger_than_terminus]
  ...
  { term := "aimed call"
    ...
    anchors := [``Grid.DirectedConvention.KsmdAimedAt]
  ...
  { term := "upāya/provisional reading"
    ...
    anchors := [``Grid.DirectedConvention.BeingConvention.GridConvention.Metaphysics.provisional_preserved,
      ``Grid.DirectedConvention.ksmdPathOught_conditional]
    seeAlso := ["tier", "separate/fuse rule", "assert/display"] },
  { term := "dukkha"
    kind := .canonical
    gloss := "Dukkha ordinarily names suffering or unsatisfactoriness. The grid derives `ClenchMismatch`; `KsmdDukkha` adds a supplied sentience mark. Thus the structure is derived while whether it is suffered remains reading-relative."
    anchors := [``Grid.KsmdMismatchGrade, ``Grid.ClenchMismatch,
      ``Grid.KsmdDukkha]
  ...
  { term := "Ksmd marker"
    kind := .leanConvention
    gloss := "The Ksmd marker flags a system-point-of-view reading. It tells readers that a Lean name reports how the grid reads a concept, not what the tradition must mean by it."
    anchors := [``Grid.KsmdAppropriates, ``Grid.KsmdMismatchGrade,
      ``Grid.DirectedConvention.KsmdReachBackFull]
    seeAlso := ["grid"] },
  ...
  { term := "defiled falsehood"
    ...
    anchors := [``Grid.KsmdDefiledFalsehood,
  ...
  { term := "vāsanā"
    ...
    anchors := [``Grid.KsmdVasana, ``Grid.sravakaArhat_not_arhat_witness]
  ...
  { term := "buddha-side shortfall"
    ...
    anchors := [``Grid.DirectedConvention.ShortfallClosedAt,
      ``OrthogonalityNegative.ksmdEffectiveTerminus_stronger_than_terminus]
  ...
  { term := "effective terminus"
    ...
    anchors := [``Grid.DirectedConvention.KsmdEffectiveTerminus,
  ...
  { term := "no-nescience"
    ...
    anchors := [``Grid.DirectedConvention.KsmdNoNescience,
  ...
  { term := "standing enlightenment"
    ...
    anchors := [``Grid.DirectedConvention.KsmdFullyEnlightened,
      ``Grid.DirectedConvention.KsmdNoNescience,
  ...
  { term := "enacted effectiveness"
    ...
    anchors := [``Grid.DirectedConvention.KsmdEffectivenessEnacted,
  ...
  { term := "enacted full enlightenment"
    ...
    anchors := [``Grid.DirectedConvention.KsmdFullyEnlightenedEnacted,
      ``Grid.DirectedConvention.KsmdFaithfulSpeechOccurrence]
  ...
  { term := "memory theorem"
    ...
    anchors := [``Grid.DirectedConvention.MemoryWitness.memory_witness,
      ``Grid.DirectedConvention.KsmdVacuousOwnershipFace,
      ``Grid.DirectedConvention.KsmdDiachronicWhose]
  ...
  { term := "covariation"
    ...
    anchors := [``Grid.KsmdMismatchGrade]
  ...
  { term := "subitism/gradualism"
    ...
    anchors := [``Grid.KsmdSuddenArrival, ``Grid.KsmdGradualArrival,
  ...
  { term := "KsmdStreamEnterer"
    kind := .leanConvention
    gloss := "KsmdStreamEnterer is the path-position reading over the first pair: rites released, view held on the seen run. It deliberately separates path display from the fruit cut."
    anchors := [``Grid.KsmdStreamEnterer]
    seeAlso := ["FactorHeld", "FactorReleased"] },
  { term := "KsmdStreamWinner"
    kind := .leanConvention
    gloss := "KsmdStreamWinner is the fruit-position reading for stream entry: rites and view are released, and Lean proves it coincides with the existing stream-entry cut class. The terminology is a checked departure from treating sotapanna as only one undivided label."
    anchors := [``Grid.KsmdStreamWinner,
      ``Grid.ksmdStreamWinner_iff_streamEntry_cutClasses]
    seeAlso := ["KsmdStreamEnterer", "FactorReleased"] },
  { term := "KsmdOnceReturner"
    kind := .leanConvention
    gloss := "KsmdOnceReturner keeps the stream-winning fruit and adds a witnessed resolve hold on the seen run. Its extra checked content is attenuation, not a new cut class."
    anchors := [``Grid.KsmdOnceReturner]
    seeAlso := ["KsmdStreamWinner", "FactorHeld"] },
  { term := "KsmdNonReturner"
    kind := .leanConvention
    gloss := "KsmdNonReturner is the fruit-position reading after resolve release. Lean proves it is exactly the non-return cut class, so the factor scheme remains a reading over the fetter lattice."
    anchors := [``Grid.KsmdNonReturner,
      ``Grid.ksmdNonReturner_iff_nonReturn_cut]
    seeAlso := ["KsmdOnceReturner", "FactorReleased"] },
  { term := "KsmdResolveAttenuation"
    kind := .leanConvention
    gloss := "KsmdResolveAttenuation gives once-return positive content: a strict resolve-class share-drop run whose final tendency has not reached the pole."
    anchors := [``Grid.KsmdResolveAttenuation,
      ``Grid.ksmdOnceReturner_attenuation_witness,
      ``Grid.registerResolve_not_released]
    seeAlso := ["KsmdOnceReturner", "re-pitch"] },
  { term := "KsmdSerialFactorRegime"
    kind := .leanConvention
    gloss := "KsmdSerialFactorRegime is the conditional voice for factor order. If the supplied regime reads seen share-drops as rites before view before resolve, it promotes path readings to fruit readings; the grid never derives the regime or any frequency claim."
    anchors := [``Grid.KsmdSerialFactorRegime,
      ``Grid.ksmdSerialFactorRegime_conditional,
      ``FactorsNegative.factor_order_underdetermined]
    seeAlso := ["KsmdResolveAttenuation", "subitism/gradualism"] },
  { term := "śraddhā"
    kind := .canonical
    ...
    anchors := [``Grid.DirectedConvention.Factive,
      ``Grid.DirectedConvention.KsmdNoNescience,
      ``Grid.DirectedConvention.ksmdFaithOught_conditional]
  ...
  { term := "icchantika"
    ...
    anchors := [``Icchantika, ``not_ksmdEffectiveTerminus_of_icchantika,
  ...
  { term := "tariki / other-power"
    ...
    anchors := [``Grid.DirectedConvention.KsmdTarikiLine,
...
def glossaryBody : String :=
  "# Glossary\n\n" ++
  "Generated from `KannoSoe/Exposition/Glossary.lean` by `lake exe exposition_gen`. " ++
...
def glossaryDoc : Exposition.Doc :=
  { id := Exposition.glossaryRef.id
    ...
    source := "KannoSoe/Exposition/Glossary.lean"
