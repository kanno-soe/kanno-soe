...
Or more formally, fixing $E$ and writing $\to$ for $\to_E$:
```math
d\to e
\quad\Longleftrightarrow\quad
\exists M,\;
...
Here $\to^*$ is the least relation generated by these rules: either take no steps, or take one step and continue.
